...
Route::get('/admin/classement/pdf', [\App\Http\Controllers\AdminController::class, 'exportClassementPDF'])->name('admin.classement.pdf');




//Route connecter enseignant
Route::middleware(['enseignant.auth'])->group(function () {
...
Route::post('/enseignants/login', [EnseignantController::class, 'logo'])->name('enseignants.logo');


//Route de validation
Route::post('/admin/enseignants/{id}/valider', [EnseignantController::class, 'valider'])->name('admin.enseignants.valider');
