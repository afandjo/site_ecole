    ...
    public function dashboard()
{
    ...
    $elevesParClasse = $eleves->groupBy('classe');
    $enseignants = Enseignant::orderBy('nom')->get();

    return view('admin.dashboard', compact('eleves', 'elevesParClasse', 'enseignants'));
}
...
public function exportClassementPDF()
{
    $elevesParClasse = \App\Models\Eleve::orderBy('classe')
        ->orderByDesc('moyenne')
        ->get()
        ->groupBy('classe');
